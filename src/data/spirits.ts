    ...
    skills: [
      {
        ...
        power: 95,
        target: 'single',
        description: 'Menghantam target dengan tinju api bertekanan tinggi.',
        effectType: 'damage',
        hitAnimation: 'flame'
      },
      {
        ...
        power: 110,
        target: 'single',
        description: 'Tebasan cakar tajam berdaya hancur tinggi yang mengorbankan sedikit HP.',
        effectType: 'damage',
        hitAnimation: 'slash'
      },
      {
        ...
        power: 80,
        target: 'all',
        description: 'Membakar seluruh musuh di hadapan dengan hempasan sayap api berkobar.',
        effectType: 'damage',
        hitAnimation: 'flame'
      },
      {
        ...
        power: 0,
        target: 'ally',
        description: 'Meningkatkan Attack sekutu sebesar 40% selama 3 ronde.',
        effectType: 'buff'
      }
    ],
    highlightSkill: {
    ...
    skills: [
      {
        ...
        power: 120,
        target: 'single',
        description: 'Menyemburkan magma cair beracun yang menghanguskan pertahanan musuh.',
        effectType: 'damage',
        hitAnimation: 'flame'
      },
      {
        ...
        power: 90,
        target: 'single',
        description: 'Mengutuk target dengan energi gelap yang menurunkan Atk & Def musuh.',
        effectType: 'debuff',
        hitAnimation: 'curse'
      }
    ],
    ...
    skills: [
      {
        ...
        power: 115,
        target: 'single',
        description: 'Menghantam musuh dengan berkas cahaya suci berkekuatan mutlak.',
        effectType: 'damage',
        hitAnimation: 'holy'
      },
      {
        ...
        power: 200,
        target: 'all_allies',
        description: 'Menyembuhkan seluruh tim dan memulihkan anggota tim yang tak sadarkan diri.',
        effectType: 'heal',
        hitAnimation: 'holy'
      }
    ],
    ...
    skills: [
      {
        ...
        power: 125,
        target: 'single',
        description: 'Menghantam satu musuh dengan tombak gletser es mutlak berdaya beku tinggi.',
        effectType: 'damage',
        hitAnimation: 'ice'
      },
      {
        ...
        power: 95,
        target: 'all',
        description: 'Memutarkan ribuan cakra es pemecah kutukan ke seluruh musuh.',
        effectType: 'damage',
        hitAnimation: 'ice'
      },
      {
        ...
        power: 140,
        target: 'all_allies',
        description: 'Membersihkan kutukan dan memulihkan HP besar seluruh anggota tim.',
        effectType: 'heal',
        hitAnimation: 'holy'
      }
    ],
    ...
    skills: [
      {
        ...
        power: 130,
        target: 'single',
        description: 'Membuka singularitas kutukan gelap yang meremukkan jiwa sasaran.',
        effectType: 'damage',
        hitAnimation: 'curse'
      },
      {
        ...
        power: 100,
        target: 'all',
        description: 'Menerjang seluruh barisan musuh dengan gelombang miasma hitam pekat.',
        effectType: 'damage',
        hitAnimation: 'curse'
      },
      {
        ...
        power: 0,
        target: 'single',
        description: 'Menurunkan Atk, Def, dan Speed musuh sebesar 40% selama 3 ronde.',
        effectType: 'debuff'
      }
    ],
    highlightSkill: {
    ...
    skills: [
      {
        ...
        power: 128,
        target: 'single',
        description: 'Menancapkan tombak plasma api murni berdaya ledak super tinggi.',
        effectType: 'damage',
        hitAnimation: 'flame'
      },
      {
        ...
        power: 102,
        target: 'all',
        description: 'Menebarkan kelopak api abadi yang membakar seluruh penjuru arena.',
        effectType: 'damage',
        hitAnimation: 'flame'
      },
      {
        ...
        power: 0,
        target: 'all_allies',
        description: 'Meningkatkan Attack seluruh tim sebesar 50% selama 3 ronde.',
        effectType: 'buff'
      }
    ],
    highlightSkill: {
    ...
    skills: [
      {
        ...
        power: 120,
        target: 'single',
        description: 'Menghujamkan berkas cahaya permata yang melumpuhkan energi hitam musuh.',
        effectType: 'damage',
        hitAnimation: 'holy'
      },
      {
        ...
        power: 300,
        target: 'all_allies',
        description: 'Memulihkan HP seluruh anggota tim hingga penuh dan memberi perisai suci.',
        effectType: 'heal',
        hitAnimation: 'holy'
      },
      {
    ...
    skills: [
      {
        ...
        power: 135,
        target: 'single',
        description: 'Tembakan jimat peluru presisi tinggi dengan peluang Critical masif.',
        effectType: 'damage',
        hitAnimation: 'slash'
      },
      {
        ...
        power: 105,
        target: 'all',
        description: 'Menembakkan ribuan proyektil jimat berpetir ke seluruh musuh.',
        effectType: 'damage',
      ...
      },
      {
        ...
        power: 0,
        target: 'ally',
        description: 'Meningkatkan Damage serangan berikutnya sebesar 100%!',
        effectType: 'buff'
      }
    ],
    highlightSkill: {
